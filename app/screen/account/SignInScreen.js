...
import {Header,TDButtonPrimary, TDButtonSecondary, TDDividerWithTitle, TDTextInputAccount} from '@app/components';
  ...
  return (
    <View style={{flex: 1, backgroundColor: Colors.primary}}>
      ...
      <View style={{flex: 1 / 3, alignContent: 'center', alignItems: 'center', justifyContent: 'center'}}>
        <Text style={{fontStyle: Fonts.type.base,color: Colors.white, fontWeight: 'bold', fontSize: 24, lineHeight: 32, }}>Hi, Welcome Back!</Text>
